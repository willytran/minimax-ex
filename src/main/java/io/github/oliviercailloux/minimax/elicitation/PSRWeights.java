...
public class PSRWeights {
   ...
   /**
    * Retrieves the weight associated to the given rank. The first position of
    * the ranking is 1.
    *
    ...
    *
    * @return the appropriate information indicating whether the term on the
    * left is greater than, equal to or lower than the right one
    */
