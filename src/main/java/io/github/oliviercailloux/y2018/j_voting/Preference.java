...
public class Preference {
    ...
    * In a set, the alternatives are equally ranked. The sets are sorted by
    * preference in the list. If an alternative is present several times, an
    ...
    * of set of alternative given. If an alternative appears several times in
