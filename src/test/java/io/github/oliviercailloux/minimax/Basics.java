...
public class Basics {
	...
	public static final Alternative a1 = new Alternative(1);
	public static final Alternative a2 = new Alternative(2);
	public static final Alternative a3 = new Alternative(3);
	public static final Voter v1 = new Voter(1);
	public static final Voter v2 = new Voter(2);
